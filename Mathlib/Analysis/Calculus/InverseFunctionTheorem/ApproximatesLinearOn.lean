...
@[deprecated (since := "2026-09-20")] alias lipschitz_sub := ApproximatesLinearOn.lipschitzWith_sub
@[deprecated (since := "2026-09-20")] alias lipschitz := ApproximatesLinearOn.lipschitzWith
...
@[deprecated (since := "2026-09-20")] alias antilipschitz := ApproximatesLinearOn.antilipschitzWith
